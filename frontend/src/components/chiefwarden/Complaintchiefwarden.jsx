...
import Randomcomplaintcheifwarden from "./Randomcomplaintchiefwarden";
        ...
        <>
          ...
          >
             {complaints.map((complaintObj, index) => (
              ...
              <SwiperSlide>
              <Randomcomplaintcheifwarden complaint={complaintObj.complaint} username={complaintObj.username}/>
            </SwiperSlide>
            </div>
          ))}
